        ...
        style={{ 
            ...
            <div className="space-y-6"> 
                <div> 
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-purple bg-opacity-20 border-2 text-white border-white border-opacity-40 placeholder-white placeholder-opacity-80 focus:outline-none focus:ring-2 focus:ring-red-900 focus:border-transparent text-center" 
                    /> 
                </div> 
                ...
                <div className="mt-6 text-center flex items-center justify-center"> 
                    ...
                    <a href='/signup' className="text-red-900 hover:text-cyan-100 underline text-sm"> 
                        Sign Up 
                        </a> 
                </div> 
            </div> 
